...
$avatar_img = $_POST["avatar"];
    ...
    print("<?xml version='1.0' encoding='utf-8' ?><!DOCTYPE response SYSTEM 'response.dtd' [<!ENTITY eacute '&#233;'><!ENTITY agrave '&#224;'>]><response success='1' msg='Avatar mis &agrave; jour'>".
          "</response>");       
