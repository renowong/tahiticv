...
Epoch.prototype.setLang = function()  //all language settings for Epoch are made here.  Check Date.dateFormat() for the Date object's language settings
{
	...
	this.months_sh = new Array('Jan','Fev','Mar','Avr','Mai','Juin','Juil','Aou','Sep','Oct','Nov','Dec');
	this.monthup_title = 'Mois suivant';
	this.monthdn_title = 'Mois pr\351c\351dent';
	this.clearbtn_caption = 'Effacer';
	this.clearbtn_title = 'Efface les dates pr\351c\351demment s\351lectionn\351es';
	this.maxrange_caption = 'Limite atteinte';
};
//-----------------------------------------------------------------------------
