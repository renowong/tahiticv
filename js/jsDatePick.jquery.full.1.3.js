...
g_l = [];
g_l["MONTHS"] = ["Janvier","F\351vrier","Mars","Avril","Mai","Juin","Juillet","Ao\373t","Septembre","Octobre","Novembre","D\351cembre"];
g_l["DAYS_3"] = ["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"];
g_l["MONTH_FWD"] = "Avancer d'un mois";
g_l["MONTH_BCK"] = "Reculer d'un mois";
g_l["YEAR_FWD"] = "Avancer d'une ann\351e";
g_l["YEAR_BCK"] = "Reculer d'une ann\351e";
...
JsDatePick.prototype.populateFieldWithSelectedDate = function(){
	...
	$("#"+this.oConfiguration.target).blur();
	this.closeCalendar();
